...
[Link is here](https://robertwwalker.github.io/BUS1301-SP26/slides/02-26-2026/index.html)


## The class plan:

1. Single sample binary inference.
2. Comparisons of binary variables.
3. Single sample quantitative inference and t.
4. Comparing quantitative variables and sampling.

Your post-class exercise:

1. The assignment: an inference example for your quantitative data.

## For Next Class:

1. Reading and review
2. Deliverable: An inference example from your data [Assignment 15].  A collation of previous exercises collected into an example for a midterm.
